...
//		LogUtil.i("saveFilepath", saveFile.getAbsolutePath());
	...
	* Description: 删除指定文件夹下所有文件,不删除文件夹，如果文件夹不存在则创建文件夹
	 ...
	 * param @param urlpath
	 */
	public static void saveLocalPicture(String urlpath, String filename){
		URL url;
		...
		try {
			...
			stringBuilder.append(Const.PATH_SHOP_PICTURE);//Environment.getExternalStorageDirectory());
			//stringBuilder.append(Const.NAME_FILE_ADPIC);//"/downpicture/"
			stringBuilder.append(filename);
			stringBuilder.append(Const.NAME_SUFFIX);//".jpg"
	 ...
	 */
	public static boolean isFileDirNull(String dirPath){
		try{
